...
#define INICIO_PIRATAA          0x551000 //Posicion de memoria de A (1, 1)
#define INICIO_PIRATAB          0x126E000 //Posicion de memoria de B (78, 42)

#define READWRITE               0x007
#define READONLY                0x005
